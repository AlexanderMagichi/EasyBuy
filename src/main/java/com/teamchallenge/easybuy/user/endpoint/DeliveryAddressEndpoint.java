...
@Tag(name = "Delivery Address Management", description = "Endpoints for managing user delivery address profiles")
public class DeliveryAddressEndpoint {
    ...
    @GetMapping
    @Operation(summary = "Get all addresses", description = "Retrieves a list of all delivery addresses associated with the current user.")
    ...
    @PostMapping
    @Operation(summary = "Create an address", description = "Creates a new delivery address for the authenticated user.")
    ...
    @Operation(summary = "Update an address", description = "Updates an existing delivery address by its ID.")
    ...
    @Operation(summary = "Delete an address", description = "Deletes a specific delivery address by its ID.")
    ...
    @Operation(summary = "Set as default", description = "Configures a specific address as the primary (default) delivery address for the user.")
