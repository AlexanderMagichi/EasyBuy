package com.teamchallenge.easybuy.security.repository;

import com.teamchallenge.easybuy.security.entity.LoginAttemptEntity;
...
public interface LoginAttemptRepository extends JpaRepository<LoginAttemptEntity, UUID> {
    ...
    int setUserLockedStatusAndExpiration(@Param("email") String userEmail, @Param("expiration") Instant expirationDatetime);
