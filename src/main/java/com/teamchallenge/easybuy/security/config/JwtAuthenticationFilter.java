...
/**
 * Filter that intercepts all HTTP requests and checks for a JWT token in the Authorization header.
 * If the token is valid, sets the authentication in the Spring Security context.
 */
@Component
